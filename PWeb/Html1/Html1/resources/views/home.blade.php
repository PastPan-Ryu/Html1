            ...
            <div class="card-body">
                ...
                <div class="card-footer">
                    <div class="card-stats">
                        <span>💎 {{ number_format($akun->harga, 0, ',', '.') }}</span>
                    </div>
                    <a href="{{ route('checkout', $akun->id_akun) }}" class="cta-btn" style="padding: 4px 12px; font-size: 0.8rem; text-decoration: none; text-align: center; {{ $akun->status == 'Terjual' ? 'background:#40444b;color:#888;pointer-events:none;' : '' }}">
    ...
    @forelse($akuns as $akun)
        <div class="card" style="display: flex; flex-direction: row; height: 120px;">
            <div class="card-image-wrapper" style="width: 120px; height: 100%;">
                ...
                <img src="{{ $akun->foto ? asset('uploads/'.$akun->foto) : 'https://ui-avatars.com/api/?name='.urlencode($akun->nama_akun).'&background=3282B8&color=fff&size=400' }}" alt="Account Image" class="card-image" style="border-radius:0; height:100%; margin-bottom:0;">
            </div>
            <div class="card-body" style="flex: 1; padding: 0.8rem; display: flex; flex-direction: column; justify-content: space-between;">
                ...
                <div class="card-footer" style="padding-top: 0.5rem; border-top: none;">
                    <div class="card-stats" style="font-size: 0.85rem; color: var(--accent); font-weight: bold;">
                        <span>💎 {{ number_format($akun->harga, 0, ',', '.') }} Point</span>
                    </div>
