...
<head>
    ...
    <title>Daftar Dashboard - Game Vault</title>
...
<body>
    <div class="auth-dashboard">
        ...
        <div class="auth-left">
            <h1>🎮 Game Vault</h1>
            <p style="font-size: 1.2rem; max-width: 80%;">Bergabunglah dengan ribuan gamer lainnya. Buat akun sekarang untuk mulai berjualan akun game!</p>
        </div>
            ...
            <div class="auth-form-container">
                ...
                <form action="{{ route('register.post') }}" method="POST">
                    ...
                    <div class="form-group" style="text-align: left; margin-bottom: 1.2rem;">
                        ...
                        <input type="email" id="email" name="email" required style="width: 100%; padding: 0.8rem; border: 1px solid var(--border); border-radius: 8px;" value="{{ old('email') }}">
                    </div>
                    <div class="form-group" style="text-align: left; margin-bottom: 1.2rem;">
                    ...
                    <div class="form-group" style="text-align: left; margin-bottom: 1.2rem;">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" required style="width: 100%; padding: 0.8rem; border: 1px solid var(--border); border-radius: 8px;">
                    </div>
                    <button type="submit" class="cta-btn" style="width: 100%; border: none; cursor: pointer;">Daftar Sekarang</button>
                </form>
                <div style="margin-top: 1.5rem; color: var(--text-light); text-align: center;">
                    Sudah punya akun? <a href="{{ route('login') }}" style="color: var(--primary); text-decoration: none; font-weight: 600;">Login di sini</a>
                </div>
            </div>
        </div>
    </div>
